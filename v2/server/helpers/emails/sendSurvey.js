...
const sendSurvey = ({ surveyURL, participantsList, survetType }) => {
  // convert the session type into capitalizesd words
  const uppercaseSurvey = survetType
    .split('-')
  ...
  <div style="text-align: center;">
    ...
    <div style="text-align: left;">
      ...
      <p>Here is the link for the "${uppercaseSurvey}" survey</p>
      ...
      <p style="font-weight: 700;">${surveyURL}</p>
...
`;
  ...
  const subject = `'${uppercaseSurvey}' suvery link`;
