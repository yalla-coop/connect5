...
// Response Schema
// Defines how we store all survey responses giving us a unique id that we can link all the answers in the answer model to the right overall survey response
